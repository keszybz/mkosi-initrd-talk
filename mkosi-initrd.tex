...
\date{\tiny Nest with Fedora, 7.8.2021}
...
\begin{frame}
  ...
  The initrd is a small file system image that the boot loader passes to the kernel.\\

  \pause

  The primary purpose of the initrd is to load the real root file system.\\
